...
public class SilverCoinItem extends DeveloperToolModElements.ModElement {
	@ObjectHolder("developer_tool:silver_coin")
	public static final Item block = null;
	public SilverCoinItem(DeveloperToolModElements instance) {
		super(instance, 2);
	}
